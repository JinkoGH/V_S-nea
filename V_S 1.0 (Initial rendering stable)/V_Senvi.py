    ...
    def create_envi(self):
        ...
        for grid_x in range(self.gridlength_x):
            ...
            for grid_y in range(self.gridlength_y):
                ...
                # Pre rendering tree nodes
                #self.oak_tree_group.blit(self.node["oak_tree"],(render_coord[0] + self.grass_group.get_width()/2, render_coord[1] + self.height / 48))
                #self.oak_tree_group.set_colorkey(black)
        return envi
