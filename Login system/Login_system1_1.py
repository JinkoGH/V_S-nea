...
def register_user():
        ...
        if results:
                Label(reg_root, text="Username taken", height="1", width="27", background="light blue").place(x=2, y=200)
                return
        #Length check
        ...
        #Captial letter check
                ...
                Label(reg_root, text="Password does not include capital letters", height="1", width="27", background="light blue").place(x=27, y=200)
                return
        #Lower case check
        elif not re.search("[a-z]", password_entry.get()):
                Label(reg_root, text="Password does not include lowercase letters", height="1", width="27", background="light blue").place(x=27, y=200)
                return
        #Number check
