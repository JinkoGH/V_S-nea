...
from V_S_Laccount import Log_screen, Reg_screen, RegInstruction_screen
from V_S_Lmain import Main_screen, LoadCreateSave
...
class Userhub_screen(tk.Frame):
    ...
    def __init__(self, master, controller):
        ...
        self.dark_bg = tk.PhotoImage(file="Images/Dark bg.png")
